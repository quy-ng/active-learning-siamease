...
__all__ = ['Inspectorio', 'InspectorioLabel', 'load_padded_data']
...
if __name__ == '__main__':
    ...
    anc_loader, pos_loader, neg_loader, max_length = InspectorioLabel.load_data(
        data_path='../data/dac/dedupe-project/new/new_generated_labeled_data.csv',
        batch_size=2, vocab=default_vocab)
